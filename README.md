...
Authenticated single-turn `POST /chat` backed by [Together AI](https://docs.together.ai/docs/render-chat-api), running as a Render web service. Express forwards one user message to chat completions and returns the reply, model ID, and token usage.
...
| --- | --- | --- | --- |
| `together-chat-ts` | Web service | Free | Spins down after 15 minutes idle |
